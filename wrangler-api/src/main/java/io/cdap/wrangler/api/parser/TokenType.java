...
public enum TokenType implements Serializable {
  ...
  /**
   * Represents the enumerated type for the object of {@code Long} type.
   * This type is associated with the token that represents strings like '10GB'
   * and '20KB'.
   */
  BYTESIZE,

  /**
   * Represents the enumerated type for the object of type {@code LongList} type.
   * This type is associated with the collection of {@code ByteSize} values
   * separated
   * by
   * comma(,). E.g.
   * <code>
  ...
  /**
   * Represents the enumerated type for the object of {@code Long} type.
   * This type is associated with the token that represents strings like '10m'
   * and '20h'.
   */
  TIMEDURATION,
  ...
  /**
   * Represents the enumerated type for the object of type {@code LongList} type.
   * This type is associated with the collection of {@code Long} values separated
   * by
   * comma(,). E.g.
   * <code>
   *   Long[,Long]*
